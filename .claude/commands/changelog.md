...
## 1. changelog-native.md 갱신 (과거를 쌓는다 · git 기준 · append)
...
> - KEND / KEND-SELLER 변경사항은 각각 `changelog-kend.md` / `changelog-seller.md`에 별도 관리 (사용자가 수동 sync).
